...
export function useTripCalculator() {
    // CORRECCIÓN 1: Inicialización del estado con 'liters'
    ...
    const calculateRoute = async (formData: TripFormData) => {
        ...
        try {
            ...
            // CORRECCIÓN 2: Incluir 'liters' en el objeto de resultados
            setResults({ 
                totalDays: dayCounter, 
                distanceKm: totalDistMeters / 1000, 
                totalCost: liters * formData.precioGasoil, 
                liters: liters, 
