...
const translations: Record<Language, TranslationMap> = {
    es: {
        ...
        'FORM_STOPOVERS_TITLE': '📍 Añadir Escalas (visitas en ruta)',
        'FORM_STOPOVER_SEARCH_PLACEHOLDER': '🔍 Buscar escala...',
        'FORM_NO_STOPOVERS': 'No hay escalas añadidas.',
    ...
    en: {
        ...
        'FORM_STOPOVERS_TITLE': '📍 Add Stopovers (visits en route)',
        'FORM_STOPOVER_SEARCH_PLACEHOLDER': '🔍 Search stopover...',
        'FORM_NO_STOPOVERS': 'No stopovers added.',
