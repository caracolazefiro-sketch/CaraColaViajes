...
export default function AppHeader({ 
    ...
    return (
        <div className="relative mb-6 no-print w-full bg-white/50 backdrop-blur-sm border-b border-gray-200 py-3">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4 px-4 max-w-6xl mx-auto">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center bg-gray-100 rounded-full p-1 border border-gray-200">
                        <button 
                            onClick={() => setLang('es')}
                            className={`px-2 py-1 rounded-full text-sm transition-all ${language === 'es' ? 'bg-white shadow text-gray-900 font-bold' : 'text-gray-400 hover:text-gray-600'}`}
                        ...
                        <button 
                            onClick={() => setLang('en')}
                            className={`px-2 py-1 rounded-full text-sm transition-all ${language === 'en' ? 'bg-white shadow text-gray-900 font-bold' : 'text-gray-400 hover:text-gray-600'}`}
