-- SQL para crear tabla roadmap en Supabase
...
CREATE POLICY "Allow public read access" ON roadmap
    FOR SELECT
    USING (true);

-- Política: permitir escritura a todos (temporal, puedes añadir auth después)
CREATE POLICY "Allow public write access" ON roadmap
    FOR ALL
    USING (true);

-- Insertar contenido inicial
INSERT INTO roadmap (id, content) VALUES (
    'main',
